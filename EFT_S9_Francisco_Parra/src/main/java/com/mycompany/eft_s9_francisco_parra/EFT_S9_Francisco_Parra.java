...
public class EFT_S9_Francisco_Parra {
    ...
    private static final String[][] zona1 = new String[FILAS][COLUMNAS];
    private static final String[][] zona2 = new String[FILAS][COLUMNAS];
    private static final String[][] zona3 = new String[FILAS][COLUMNAS];
    ...
    private static final List<String> promociones = List.of("10% Estudiantes", "15% Tercera Edad");
    ...
    private static void menu() {
        ...
        do {
            ...
            System.out.println("8. Buscar Entradas por Cliente");
            ...
            switch (opcion) {
                ...
                case 8 -> buscarEntradasPorCliente();
    ...
    private static void visualizarResumenVentas() {
        ...
        int totalVIP = 0, totalPlatea = 0, totalBalcon = 0;
        ...
        System.out.println("Entradas vendidas por zona:");
        System.out.println("VIP: " + totalVIP + ", PLATEA: " + totalPlatea + ", BALCÓN: " + totalBalcon);
    ...
    private static void confirmarReserva() {
        ...
        entrada.esReservaConfirmada = true;
        carritoCompras.add(entrada);
   ...
   public static class Entrada {
    ...
    private static void buscarEntradasPorCliente() {
        System.out.print("Ingrese nombre o ID del cliente: ");
        String input = scanner.nextLine().trim();
        try {
            int idBuscado = Integer.parseInt(input);
            carritoCompras.stream()
                .filter(e -> e.nuevoCliente.idCliente == idBuscado)
                .forEach(System.out::println);
        } catch (NumberFormatException ex) {
            carritoCompras.stream()
                .filter(e -> e.nuevoCliente.nombre.equalsIgnoreCase(input))
                .forEach(System.out::println);
        }
    }
}
